...
$email=@$_GET['email'];
$resul = mysqli_query($con,"DELETE FROM staff WHERE email='$email' ") or die('Error');
...
$desc = $_POST['desc'];
$id=uniqid();
$q3=mysqli_query($con,"INSERT INTO quiz VALUES  ('$id','$name' , '$sahi' , '$wrong','$total','$time' , '$desc' , '$branch' , '$sem',NOW())");
